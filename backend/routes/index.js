...
router.put('/products/:sku', auth, rbac(['ADMIN']), product.update)
router.get('/products', auth, product.list)
router.get('/products/:sku', auth, product.detail)

// ==================== 仓库管理 ====================
router.post('/warehouses', auth, rbac(['ADMIN']), warehouse.create)
router.put('/warehouses/:code', auth, rbac(['ADMIN']), warehouse.update)
router.get('/warehouses', auth, warehouse.list)
router.get('/warehouses/:code', auth, warehouse.detail)
